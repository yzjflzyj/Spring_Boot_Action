...
public class AclClient {
    ...
    public static void producer() throws MQClientException {
        ...
        for (int i = 0; i < 128; i++)
            try {
                {
                    Message msg = new Message("AclClientTopic",
                        "TagA",
                        "OrderID188",
    ...
    public static void pushConsumer() throws MQClientException {
        ...
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("AclClientPushConsumer", getAclRPCHook(), new AllocateMessageQueueAveragely());
        consumer.setNamesrvAddr("192.168.218.131:9876;192.168.218.132:9876;192.168.218.133:9876");
        consumer.subscribe("AclClientTopic", "*");
    ...
    public static void pullConsumer() throws MQClientException {
        DefaultMQPullConsumer consumer = new DefaultMQPullConsumer("AclClientPullConsumer", getAclRPCHook());
        consumer.setNamesrvAddr("192.168.218.131:9876;192.168.218.132:9876;192.168.218.133:9876");
        consumer.start();

        Set<MessageQueue> mqs = consumer.fetchSubscribeMessageQueues("AclClientTopic");
